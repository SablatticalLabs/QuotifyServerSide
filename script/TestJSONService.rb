...
#print QuoteService.post("/quotes/", :body => {"quote"=>{"quote_text"=>"Something Great","quotifier"=>{"email"=>"sabag.lior@gmail.com"},"speaker"=>{"name"=>"Max Rosenblatt","email"=>"maxrosenblatt@gmail.com"},"time"=>"2011-12-04 00=>53","location"=>"Stockton St, San Francisco"}})
